...
varout = file_croco_abl_ifs.createVariable('uwnd'     ,'d',('bulk_time', 'eta_rho', 'xi_u'  )) ; varout.long_name = 'u-wind speed'                    ; varout.units = 'm/s'
varout = file_croco_abl_ifs.createVariable('vwnd'     ,'d',('bulk_time', 'eta_v'  , 'xi_rho')) ; varout.long_name = 'v-wind speed'                    ; varout.units = 'm/s'
