...
uhpg_ifs     = ds_abl_ifs.uhpg
vhpg_ifs     = ds_abl_ifs.vhpg
prate_ifs    = ds_ifs.tp
...
uwnd_abl     = uwnd_ifs.interp    (lat=lat_rho, lon=lon_rho, method='linear')
vwnd_abl     = vwnd_ifs.interp    (lat=lat_rho, lon=lon_rho, method='linear')
uhpg_abl     = uhpg_ifs.interp    (lat=lat_rho, lon=lon_rho, method='linear')
vhpg_abl     = vhpg_ifs.interp    (lat=lat_rho, lon=lon_rho, method='linear')
...
file_croco_abl_ifs=netCDF4.Dataset(os.getcwd()+'/croco_abl_from_ifs_era5_N_abl_'+str(N_abl)+'_interp_linear.nc','w')
file_croco_abl_ifs.Description='Atmospheric forcing file for ABL/CROCO'
...
file_croco_abl_ifs.createDimension ('N_abl',     N_abl)
...
varout = file_croco_abl_ifs.createVariable('tair'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'Air temperature'                 ; varout.units = 'Celsius'
varout = file_croco_abl_ifs.createVariable('rhum'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'Air specific humidity'           ; varout.units = 'kg/kg'
...
varout = file_croco_abl_ifs.createVariable('uhpg'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'u-hpg'                           ; varout.units = 'm/s'
varout = file_croco_abl_ifs.createVariable('vhpg'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'v-hpg'                           ; varout.units = 'm/s'
varout = file_croco_abl_ifs.createVariable('uwnd'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'u-wind speed'                    ; varout.units = 'm/s'
varout = file_croco_abl_ifs.createVariable('vwnd'     ,'d',('bulk_time', 'N_abl', 'eta_rho', 'xi_rho')) ; varout.long_name = 'v-wind speed'                    ; varout.units = 'm/s'
varout = file_croco_abl_ifs.createVariable('zr'       ,'d',(             'N_abl'                     )) ; varout.long_name = 'Altitude of t-level'             ; varout.units = 'm'
varout = file_croco_abl_ifs.createVariable('zw'       ,'d',(             'N_abl'                     )) ; varout.long_name = 'Altitude of w-level'             ; varout.units = 'm'
varout = file_croco_abl_ifs.createVariable('Hzr'      ,'d',(             'N_abl'                     )) ; varout.long_name = 'Thickness of t-level'            ; varout.units = 'm'
varout = file_croco_abl_ifs.createVariable('Hzw'      ,'d',(             'N_abl'                     )) ; varout.long_name = 'Thickness of w-level'            ; varout.units = 'm'

# ---------------------------------------
# Write out the data arrays into the file
# ---------------------------------------
file_croco_abl_ifs.variables['bulk_time'][:      ] = time_abl     [:      ]/24.0              # from hours to days
file_croco_abl_ifs.variables['tair']     [:,:,:,:] = tair_abl     [:,:-1,:,:]-273.15          # from K to C
file_croco_abl_ifs.variables['rhum']     [:,:,:,:] = rhum_abl     [:,:-1,:,:]
file_croco_abl_ifs.variables['uhpg']     [:,:,:,:] = uhpg_abl     [:,:-1,:,:]
file_croco_abl_ifs.variables['vhpg']     [:,:,:,:] = vhpg_abl     [:,:-1,:,:]
file_croco_abl_ifs.variables['uwnd']     [:,:,:,:] = uwnd_abl     [:,:-1,:,:]
file_croco_abl_ifs.variables['vwnd']     [:,:,:,:] = vwnd_abl     [:,:-1,:,:]
file_croco_abl_ifs.variables['zr']       [  :    ] = zr_abl       [  :    ]
file_croco_abl_ifs.variables['zw']       [  :    ] = zw_abl       [  :    ]
file_croco_abl_ifs.variables['Hzr']      [  :    ] = Hzr_abl      [  :    ]
file_croco_abl_ifs.variables['Hzw']      [  :    ] = Hzw_abl      [  :    ]
